...
#define CUSTOM_MACHINE_NAME "SKR Ender-3 Max"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 401.5
  #define DEFAULT_bedKi 54.55
  #define DEFAULT_bedKd 1970
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -28, -42, -3.5 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 10, 10, 35, 45 } // (mm) Left, Front, Right, Back insets
